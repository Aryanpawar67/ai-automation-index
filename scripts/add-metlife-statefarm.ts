/**
 * Adds MetLife and State Farm to the pipeline, each in its own standalone batch.
 ...
 *
 * Run: npx tsx --env-file=.env.local scripts/add-metlife-statefarm.ts
 */
...
const COMPANIES: Array<{ name: string; careerPageUrl: string; atsType: string | null }> = [
  {
    name:          "MetLife",
    careerPageUrl: "https://www.metlifecareers.com/en_US/ml/SearchJobs",
    atsType:       null,
  },
  {
    name:          "State Farm",
    careerPageUrl: "https://jobs.statefarm.com/main/jobs",
    atsType:       null,
  },
];
