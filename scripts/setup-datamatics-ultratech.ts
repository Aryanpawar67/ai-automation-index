...
const TARGETS: Target[] = [
  {
    name:          "Datamatics",
    careerPageUrl: "https://www.datamatics.com/human-resources/job-openings",
    total:         30,
  },
  {
    name:          "UltraTech Cement",
    careerPageUrl: "https://www.ultratechcement.com/corporate/career/jobs-at-ultratech",
    total:         58,
  },
];
...
async function setupCompany(t: Target): Promise<string> {
  ...
  if (existing) {
    ...
    console.log(`Existing company ${t.name}:`, existing);
